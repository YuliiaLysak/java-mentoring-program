...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<Long, Notification> producerFactory(
    ...
    @Bean
    public KafkaTemplate<Long, Notification> kafkaTemplate(
            ProducerFactory<Long, Notification> producerFactory
    ) {
