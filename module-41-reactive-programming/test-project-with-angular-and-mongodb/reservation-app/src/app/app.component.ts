...
export class AppComponent {
  ...
  // added '!' instead of 'undefined'. Another way - in tsconfig.json set "strictPropertyInitialization": false
  ...
  createReservation() {
    this.reservationService
      .createReservation(new ReservationRequest(this.currentRoomNumber,
